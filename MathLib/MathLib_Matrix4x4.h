...
void matrix4x4_copy(matrix4x4& dest, const matrix4x4& src);
...
public:
	...
	/// <summary>
	/// Loads this matrix with the required elements to rotate around the y-axis by angle.
	/// Angle is expressed in degrees.
	/// </summary>
	...
	/// <summary>
	/// Loads this matrix with the required elements to rotate around the z-axis by angle.
	/// Angle is expressed in degrees.
	/// </summary>
	...
	/// <summary>Loads this matrix with the required elements to scale along the three axes.</summary>
	...
	/// <summary>Loads this matrix with the required elements to translate to the provided point.</summary>
	...
	/// <summary>Loads this matrix with the provided elements.</summary>
	...
	/// <summary>Convenience method. Stores the position/translation component of the affine transform into the vector.</summary>
	...
	{
		// We have to do it this way as our elements are stored backwards.
		array[0] = _00;
		array[1] = _10;
		array[2] = _20;
		array[3] = _30;
...
///		!! WARNING: The three matrices must be distinct, the result will be 
///		incorrect if result is the same object as matrix1 or matrix2.!!
/// </summary.
...
/// <summary>Computes the determinant of the given matrix.</summary>
