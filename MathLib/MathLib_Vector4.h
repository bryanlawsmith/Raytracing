...
void vector4_copy(vector4& dest, const vector4& src);
...
MATHLIB_INLINE void vector4_copy(vector4& dest, const vector4& src)
{
	...
	dest.setXYZW(src.x, src.y, src.z, src.w);
...
MATHLIB_INLINE void vector4_add(const vector4& vector1, const vector4& vector2, vector4& result)
{
	...
	result.setXYZW(vector1.x + vector2.x, 
		vector1.y + vector2.y,
		vector1.z + vector2.z,
		vector1.w + vector2.w);
...
MATHLIB_INLINE void vector4_scale(const vector4& vector1, float scaleFactor, vector4& result)
{
	...
	result.setXYZW(vector1.x * scaleFactor,
		vector1.y * scaleFactor,
		vector1.z * scaleFactor,
		vector1.w * scaleFactor);
...
/// </summary>
MATHLIB_INLINE void vector4_addScaledVector(const vector4& vector1, const vector4& 
	vector2, float scaleFactor, vector4& result)
{
#if (MATHLIB_SIMD)
#if (MATHLIB_SSE)
	...
	result.setXYZW(vector1.x + (vector2.x * scaleFactor),
				   vector1.y + (vector2.y * scaleFactor),
				   vector1.z + (vector2.z * scaleFactor),
				   vector1.w + (vector2.w * scaleFactor));
...
/// Computes the component product of the two vectors and stores the result in result.
{
	...
	float xresult = vector1.x * vector2.x;
	float yresult = vector1.y * vector2.y;
	float zresult = vector1.z * vector2.z;
	float wresult = vector1.w * vector2.w;
...
/// Returns the dot product of the two vectors. This does not take the w component into account.
{
	...
	float xcomp = vector1.x * vector2.x;
	float ycomp = vector1.y * vector2.y;
	float zcomp = vector1.z * vector2.z;
...
/// Returns the distance between the two vectors.
{
	...
	float xcomp = vector2.x - vector1.x;
	float ycomp = vector2.y - vector1.y;
	float zcomp = vector2.z - vector1.z;
